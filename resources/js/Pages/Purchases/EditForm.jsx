                ...
                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div className="p-6 bg-white border-b border-gray-200">              
                        ...
                        <div className='p-6 block text-left'>
                          <h1>
                          Subtotal :  <span id='sub_total'>{values.total_amount + values.discount_amount }</span>
                          </h1>
                          
                          <h1>
                          Discount Amount : <span id='discount_amount'> {values.discount_amount }</span>
                          </h1> 
                          <h1>
                          Total : <span id='total'> {values.total_amount} </span>
                          </h1>
                        </div>
