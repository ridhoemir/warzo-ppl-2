...
export default function EditForm({ data, urlPost ,auth, errors }) {
    // return (
    //     <AuthenticatedLayout
    //         auth={auth}
    //         errors={errors}
    ...
    //                     </div>
    //                 </div>
    //             </div><select name="" id="" disabled="disabled"></select>
    //         </div>
    //         <div className="py-6">
    //             <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
    //                 <div className="flex bg-white overflow-hidden shadow-sm sm:rounded-lg p-3">
    //                   <form className="w-full text-center" action={route("category.edit.post",data.id)} method="patch">
    //                     {/* {csrf_field()} */}
    ...
    //                       <input type="text" id="category_name" className="text-center m-auto w-80 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="e.g Side Dish" value={data.category_name} required/>
    //                     </div>
    ...
    //                       <input type="text" id="category_code" className="text-center m-auto w-80 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500" value={data.category_code} required/>
    //                     </div>
