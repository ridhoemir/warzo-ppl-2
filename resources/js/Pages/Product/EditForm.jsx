...
export default function EditForm({ data, categories, urlPost ,auth, errors }) {
      const [values, setValues] = useState({
        product_code: data.product_code || "",
        product_name: data.product_name || "",
        product_note: data.product_note || "",
        product_quantity: Number(data.product_quantity) || 0,
                    ...
                    <div className="p-6 bg-white border-b border-gray-200">              
                      <form className="w-full text-center" onSubmit={handleSubmit}>
                        ...
                        <div className="mb-6 text-center">
                          ...
                          {categories.length > 0 && 
                          <select name="category_id" id="category_id" onChange={handleChange} value={values.category_id}>
